...
- **Add checklist items** — a ghost *+ Add item* row at the end of every checklist appends a real task line in place, matching the list's bullet style and indentation, and keeps the input open for the next one
